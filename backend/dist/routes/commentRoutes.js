...
router.post("/:productId", (0, express_2.requireAuth)(), commentController.createComment);
// DELETE /api/comments/:commentId - Delete comment (protected)
router.delete("/:commentId", (0, express_2.requireAuth)(), commentController.deleteComment);
