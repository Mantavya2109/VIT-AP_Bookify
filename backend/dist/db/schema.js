...
exports.commentsRelations = exports.productRelations = exports.userRelations = exports.comments = exports.products = exports.users = void 0;
...
exports.productRelations = (0, drizzle_orm_1.relations)(exports.products, ({ one, many }) => ({
    comments: many(exports.comments), //one-product -> many-comments
    user: one(exports.users, { fields: [exports.products.userId], references: [exports.users.id] }), //many-products -> one-user
...
exports.commentsRelations = (0, drizzle_orm_1.relations)(exports.comments, ({ one }) => ({
    user: one(exports.users, { fields: [exports.comments.userId], references: [exports.users.id] }), //many-comments -> one-user
